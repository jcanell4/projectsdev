...
/**
 * DokuModelManager:
 * - proporciona acceso a las Autorizaciones, ModelAdapter y Renderer del proyecto 'prgfpfct'
...
class prgfpfctDokuModelManager extends AbstractModelManager{
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \prgfpfct\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\prgfpfct");
