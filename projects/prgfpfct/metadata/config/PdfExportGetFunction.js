require([
    ...
    var prgfpfctPdfExportButton = registry.byId('prgfpfctPdfExportButton');
    ...
    if (prgfpfctPdfExportButton){
        prgfpfctPdfExportButton.getQuery=fGetQuery;
        prgfpfctPdfExportButton.set("hasTimer", true);
        prgfpfctPdfExportButton.onClick =fOnClick;
    }
});
