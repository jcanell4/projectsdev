require([
        ...
        var platreballfpPdfExportButton = registry.byId('platreballfpPdfExport');
        ...
        if (platreballfpPdfExportButton){
            platreballfpPdfExportButton.getQuery=fGetQuery;
            platreballfpPdfExportButton.set("hasTimer", true);
            platreballfpPdfExportButton.onClick =fOnClick;
        }
});
