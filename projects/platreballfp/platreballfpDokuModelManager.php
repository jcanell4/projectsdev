...
class platreballfpDokuModelManager extends AbstractModelManager{
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \platreballfp\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\platreballfp");
