...
/**
 * DokuModelManager:
 * - proporciona acceso a las Autorizaciones, ModelAdapter y Renderer del proyecto 'btxfinals'
...
class btxfinalsDokuModelManager extends AbstractModelManager{
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \btxfinals\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\btxfinals");
