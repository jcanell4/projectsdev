require([
    ...
    var btxfinalsPdfExportButton = registry.byId('btxfinalsPdfExport');
    ...
    if (btxfinalsPdfExportButton){
        btxfinalsPdfExportButton.getQuery=fGetQuery;
        btxfinalsPdfExportButton.set("hasTimer", true);
        btxfinalsPdfExportButton.onClick =fOnClick;
    }
});
