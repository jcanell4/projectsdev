require([
        ...
        var manualHtmlExportButton = registry.byId('manualHtmlExport');
        ...
        if (manualHtmlExportButton){
            manualHtmlExportButton.getQuery=fGetQuery;
            manualHtmlExportButton.set("hasTimer", true);
            manualHtmlExportButton.onClick =fOnClick;
        }
});
