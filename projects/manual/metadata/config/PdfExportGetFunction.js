require([
    ...
    var manualPdfExportButton = registry.byId('manualPdfExport');
    ...
    if (manualPdfExportButton){
        manualPdfExportButton.getQuery=fGetQuery;
        manualPdfExportButton.set("hasTimer", true);
        manualPdfExportButton.onClick =fOnClick;
    }
});
