require([
        ...
        var ptfplogseHtmlExportButton = registry.byId('ptfplogseHtmlExport');
        ...
        if (ptfplogseHtmlExportButton){
            ptfplogseHtmlExportButton.getQuery=fGetQuery;
            ptfplogseHtmlExportButton.set("hasTimer", true);
            ptfplogseHtmlExportButton.onClick =fOnClick;
        }
});
