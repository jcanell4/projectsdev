require([
    ...
    var qdocPdfExportButton = registry.byId('qdocPdfExport');
    ...
    if (qdocPdfExportButton){
        qdocPdfExportButton.getQuery=fGetQuery;
        qdocPdfExportButton.set("hasTimer", true);
        qdocPdfExportButton.onClick =fOnClick;
    }
});
