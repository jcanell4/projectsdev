require([
        ...
        var guiesgesPdfExportButton = registry.byId('guiesgesPdfExport');
        ...
        if (guiesgesPdfExportButton){
            guiesgesPdfExportButton.getQuery=fGetQuery;
            guiesgesPdfExportButton.set("hasTimer", true);
            guiesgesPdfExportButton.onClick =fOnClick;
        }
});
