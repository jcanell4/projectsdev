<?php
/**
 * upgrader_16: Transforma el archivo continguts.txt del proyecto "ptfploe" desde la versión 15 a la versión 16
    ...
    public function process($type, $ver, $filename = NULL) {
        switch ($type) {
            ...
            case "templates":
                ...
                $plantilla = @file_get_contents(WIKI_IOC_PROJECT."metadata/plantilles/continguts.txt.v16");
