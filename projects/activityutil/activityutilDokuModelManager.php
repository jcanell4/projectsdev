...
/**
 * DokuModelManager:
 * - proporciona acceso a las Autorizaciones, ModelAdapter y Renderer del proyecto 'activityutil'
...
class activityutilDokuModelManager extends AbstractModelManager{
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \activityutil\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\activityutil");
