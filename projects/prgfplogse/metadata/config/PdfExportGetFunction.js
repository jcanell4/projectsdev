require([
    ...
    var prgfplogsePdfExportButton = registry.byId('prgfplogsePdfExportButton');
    ...
    if (prgfplogsePdfExportButton){
        prgfplogsePdfExportButton.getQuery=fGetQuery;
        prgfplogsePdfExportButton.set("hasTimer", true);
        prgfplogsePdfExportButton.onClick =fOnClick;
    }
});
