...
class prgfplogseDokuModelManager extends AbstractModelManager{
    ...
    public function getAuthorizationManager($str_command) {
        ...
        $factory = \prgfplogse\FactoryAuthorization::Instance(self::$defDirClass['Authorization'], "\prgfplogse");
